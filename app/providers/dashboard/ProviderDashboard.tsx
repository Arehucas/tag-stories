...
function ProviderDashboardGate() {
  ...
  return <ProviderDashboardContent provider={provider} stories={stories} hasIGToken={hasIGToken} setHasIGToken={setHasIGToken} campaignActive={campaignActive} loadingStories={loadingStories} loadingCampaignActive={loadingCampaignActive} campaignNames={campaignNames} shareUrl={shareUrl} />;
}

// Refactorizo ProviderDashboardContent para recibir props y no hacer fetch internos
interface ProviderDashboardContentProps {
  provider: any;
  stories: any[];
  hasIGToken: boolean;
  setHasIGToken: (v: boolean) => void;
  campaignActive: boolean | null;
  loadingStories: boolean;
  loadingCampaignActive: boolean;
  campaignNames: Record<string, string>;
  shareUrl: string;
}

function ProviderDashboardContent({ provider, stories, hasIGToken, setHasIGToken, campaignActive, loadingStories, loadingCampaignActive, campaignNames, shareUrl }: ProviderDashboardContentProps) {
...
export default ProviderDashboardGate;